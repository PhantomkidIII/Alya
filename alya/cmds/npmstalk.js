function _0xeeb8() {
    const _0x4918ed = [
        ...
        'split',
        'includes',
        '\x0a\x0a>\x20©𝟐𝟎𝟐𝟒\x20𝐐𝐔𝐄𝐄𝐍 𝐀𝐋𝐘𝐀
        'npm',
        'startsWith',
        'message',
        '1650dLlsxw',
...
const {generateWAMessageFromContent, proto} = _0x270584, npmstalk = async (_0x5593ed, _0x241c7c) => {
        ...
        if (_0x46cece[_0x45c787(0x15b)](_0x27fab6)) {
            ...
            try {
                ...
                console['error']('Error\x20getting\x20Gifted\x20API\x20response:', _0xc3d0f4[_0x45c787(0x15f)]), _0x5593ed[_0x45c787(0x165)]('Error\x20getting\x20response\x20from\x20Alya\x20API.'), await _0x5593ed[_0x45c787(0x16b)]('❌');
            }
        }
    };
