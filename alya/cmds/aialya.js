...
const AiGifted = async (_0x3c99ab, _0x2a2231) => {
  ...
  const _0x442cf7 = ["alyaai", 'ai', "chatgptv2", "chatgpt4v2", "gptv2", "gpt4v2"];
  if (_0x442cf7.includes(_0xc33afa)) {
    if (!_0x15f1f4) {
      await _0x3c99ab.reply("Hello _*" + _0x3c99ab.pushName + "*_ , Please provide your query, e.g., *.ai What is the meaning of alya*");
    }
    try {
      ...
      const _0x25cc50 = [{
        'role': "system",
        'content': "You're a WhatsApp bot called Queen_Alya that processes users text and accepts commands. You work courtesy of Bing from Microsoft."
      }, {
        'role': "user",
        'content': _0x15f1f4
      }];
